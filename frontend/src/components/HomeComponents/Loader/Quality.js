...
const Quality = () => {
    ...
    t1.to(Fourth.current.children[0] , {translateY: "-168.5rem",duration:3,ease: 'Hop'})
    t1.to(Third.current.children[0] , {translateY: "-48.5rem",duration:3,ease: 'Hop'},'-=2.8')
    ...
    var t2 = gsap.timeline({
      ...
      t2.to(Journey.current.children[1],{duration: 2,ease: "Hop",clipPath:" polygon(0% 84%, 100% 83%, 100% 100%, 0% 100%)"})
      
      t2.to(Text.words , {translateY: -50, stagger: {
        amount:.1,
       },duration: 1,ease: "Hop"} ,'+=3')
       t2.to([Containera.current,Containera1.current,Containera2.current,Containera3.current], {duration: 1,ease: "Hop",translateY: -200,autoAlpha: .2},'-=2')
       t2.to([Containera.current,Containera1.current,Containera2.current,Containera3.current], {autoAlpha: 0},'-=1.5')


       t2.to(Journey.current.children[1],{duration: 1,autoAlpha: 0, translateY:-10,
        onComplete: ()=>{
            navigate('/home')
        }
    },'-=.5')
